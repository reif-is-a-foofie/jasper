...
Only the granted subset matters on the wire. Any permissions omitted from `result.permissions` are treated as denied, and any permissions not present in the original request are ignored by the server.
