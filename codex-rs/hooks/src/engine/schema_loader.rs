...
mod tests {
    ...
    fn loads_generated_hook_schemas() {
        ...
        assert_eq!(
            schemas.session_start_command_input["definitions"]["session-start.command.input"]["type"],
            "object"
        );
        assert_eq!(
            schemas.session_start_command_output["definitions"]["session-start.command.output"]["type"],
            "object"
        );
        assert_eq!(
            schemas.stop_command_input["definitions"]["stop.command.input"]["type"],
            "object"
        );
        assert_eq!(
            schemas.stop_command_output["definitions"]["stop.command.output"]["type"],
            "object"
        );
    }
}
